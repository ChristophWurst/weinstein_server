...
@section('content')
<h1>Katalognummern importieren</h1>
    ...
    <div class="row">
        <div class="col-sm-8 col-md-6">
            ...
            <ul>
				...
				<li>Spalte B enthält die Kostnummer</li>
            </ul>
        </div>
        <div class="col-sm-4 col-md-6">
            Beispiel:<br>
            <img src="{!! asset('img/example/kdb_sosi_chosen_import.png') !!}" alt="Katalognummern importieren" />
        </div>
    </div>
</div>
