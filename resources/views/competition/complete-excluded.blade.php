...
@section('content')
<h1>Ausschluss Zuweisung abschlie&szlig;en</h1>
{!! Form::open() !!}
    Sind Sie sicher, dass sie die Zuweisung der vom Ausschank ausgeschlossenen Weine abschlie&szlig;en wollen?<br>
