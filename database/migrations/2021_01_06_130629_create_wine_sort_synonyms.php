...
class CreateWineSortSynonyms extends Migration
{
    public function up(): void
    {
        Schema::table('winesort', function (Blueprint $table) {
            $table->json('synonyms')->nullable()->default(null);
        });
        Schema::table('wine', function (Blueprint $table) {
            $table->string('winesort_synonym')->nullable();
        });
    ...
    public function down(): void
    {
        ...
        Schema::table('wine', function (Blueprint $table) {
            $table->dropColumn('winesort_synonym');
        });
