...
class UserTest extends TestCase {
    ...
    public function testHasActivityLog() {
        $this->assertHasMany('activitylogs', 'User');
    }
    
    public function testHasApplicants() {
        $this->assertHasMany('applicants', 'User');
    }
    
    public function testHasAssociations() {
        $this->assertHasMany('associations', 'User');
    }

    public function testHasCompetitions() {
        $this->assertHasMany('competitions', 'User');
    }

    public function testHasTastingSessions() {
        $this->assertHasMany('tastingsessions', 'User');
    }
