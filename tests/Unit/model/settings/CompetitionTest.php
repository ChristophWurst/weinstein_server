...
class CompetitionTest extends TestCase {
    ...
    public function testBelongsToCompetitionState() {
        $this->assertBelongsTo('competitionstate', 'Competition');
    }
    
    public function testBelongsToUser() {
        $this->assertBelongsTo('user', 'Competition');
    }
    
    public function testHasManyTastingSessions() {
        $this->assertHasMany('tastingsessions', 'Competition');
    }
    
    public function testHasManyWines() {
        $this->assertHasMany('wines', 'Competition');
    }
}
